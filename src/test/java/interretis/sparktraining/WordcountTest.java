...
public class WordcountTest {
    ...
    public static final Tuple2Comparator TUPLE_2_COMPARATOR = new Tuple2Comparator();
    /** System under test. */
    ...
    public void second_test() throws IOException {
        ...
        // given
        final List<String> lines = Files.readLines(new File("src/main/resources/words.txt"), Charsets.UTF_8);
        ...
        // then it doesn't break
        final JavaPairRDD<String, Integer> expected = context.parallelizePairs(
                asList(
